...
func (e UserEdges) SegmentsOrErr() ([]*Segment, error) {
	if e.loadedTypes[0] {
...
// QuerySegments queries the "segments" edge of the User entity.
func (u *User) QuerySegments() *SegmentQuery {
	return NewUserClient(u.config).QuerySegments(u)
}
